...
class JElementMultitypes extends JElement
{
	/**
	 * Element name
	 *
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if ($value) {
			...
			$article->title = JText::_('Select Types');
		}
		...
		$link = 'index.php?option=com_properties&amp;view=types&amp;layout=multimodal&amp;tmpl=component&amp;object='.$name.'&amp;value='.$value;
