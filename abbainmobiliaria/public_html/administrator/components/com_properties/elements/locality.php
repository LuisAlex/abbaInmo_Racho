...
class JElementLocality extends JElement
{
	/**
	 * Element name
	 *
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if ($value) {
			$article->title = $locality_name;
		} else {
			$article->title = JText::_('Select an Locality');
		}
		...
		$link = 'index.php?option=com_properties&amp;view=localities&amp;layout=modal&amp;tmpl=component&amp;object='.$name;
