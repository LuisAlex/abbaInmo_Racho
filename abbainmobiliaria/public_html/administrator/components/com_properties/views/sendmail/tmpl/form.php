   ...
   <div class="submenu-box">
	<div class="submenu-pad">
		<ul id="submenu" class="configuration">       
             		<li><a id="textmail" class="active"><?php echo JText::_('textmail'); ?></a></li>
            		<li><a id="data"><?php echo JText::_('Data'); ?></a></li>
                    ...
                    <li><a id="params"><?php echo JText::_('Params'); ?></a></li>          
		</ul>
		<div class="clr"></div>
	</div>
</div>
...
<div id="page-textmail" class="tab">
<div class="noshow">
<div style="width:100%; float:left">
<fieldset class="adminform">    
	<legend><?php echo JText::_( 'Mail Text' ); ?></legend>

<table class="adminform">
<tr><td>
<?php
		$editors = &JFactory::getEditor();		
echo $editors->display('sendtextmail', $this->datos->sendtextmail, '100%', '200', '60', '20');
?>
</td></tr>
</table>
</fieldset>
...
<td>
<?php echo $this->datos->name_category;?>
</td>
                </tr>                 
	...
	<tr>
					...
					<td>
                   <?php echo $this->datos->name_country;?>
                                         </td> 
	...
	<tr>                
      <td class="key"><label for="catid"><?php echo JText::_( 'State' ); ?>:</label></td>
		<td>
          <?php echo $this->datos->name_state;?>
              </td>
</tr>
				<tr><td class="key"><?php echo JText::_( 'Locality' ); ?>:</td>
					<td>
	      <?php echo $this->datos->name_locality;?>
                ...
                <tr>
					...
					<td >
                    <?php echo JText::_( 'DETAILS_MARKET'.$this->datos->available ); ?>
		</td>
	...
	<td><?php echo $this->datos->video;?></td>
...
<table class="adminform"><tr><td>
 ...
 <?php		
// $pane_params	= &JPane::getInstance('sliders', array('allowAllClose' => true));								
				//echo $pane_params->startPane("content-pane");				
		$form = new JParameter('', JPATH_COMPONENT.DS.'models'.DS.'product.xml');				
		$form->loadINI($this->datos->params);			
		//$title = JText::_( 'Parameters - soluciones' );	
		//echo $pane_params->startPanel( $title, "detail-page" );						
		echo $form->render('params','details');		
		//echo $pane_params->endPanel();
		//		echo $pane_params->endPane();				
?>
...
<input type="hidden" name="controller" value="sendmail" />
