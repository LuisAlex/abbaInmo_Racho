...
?>		
        ...
        <img src="images/properties/images/thumbs/<?php echo $row->id; ?>/<?php echo $img;?>" border="0" class="NewsImg" alt="<?php echo $row->name;?>" width="<?php echo $widthThumb; ?>"/>
        </a>
 <?php 
				if($watermark)
				{
...
<script language="javascript" type="text/javascript">
			...
			var ver = new Ticker('TickerVertical<?php echo $module->id; ?>',{speed:4000,delay:5000,direction:'vertical'});
		</script>