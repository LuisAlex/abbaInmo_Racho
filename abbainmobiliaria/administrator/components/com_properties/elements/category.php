...
class JElementCategory extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if ($value) {
			$article->title = $category_name;
		} else {
			$article->title = JText::_('Select Category');
		}
		...
		$link = 'index.php?option=com_properties&amp;view=categories&amp;layout=modal&amp;tmpl=component&amp;object='.$name;
