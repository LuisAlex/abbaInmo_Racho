	...
	<fieldset class="adminform">
		...
		<table class="admintable">
         <tr>
			...
			<td>            
            <input class="text_area" type="text" name="name" id="name" size="60" value="<?php echo $this->category->name; ?>"/>			
			</td>
		</tr>        
        <tr>
			<td width="100" align="right" class="key">
         ...
         <tr>
			...
			<td>
				<?php 
				echo SelectHelper::SelectCurrency( $this->category->cat_currency,'cat_currency' ); 
				?>
			</td>
		</tr>  
