	...
	<fieldset class="adminform">
		...
		<table class="admintable">
         <tr>
            ...
            <input class="text_area" type="text" name="name" id="name" size="60" maxlength="250" value="<?php echo $this->locality->name;?>" />		
			</td>
		</tr>        
        <tr>
			<td width="100" align="right" class="key">
...
<?php if($this->locality->published==''){$chequeado1 = JText::_( 'checked="checked"' );}?>    
