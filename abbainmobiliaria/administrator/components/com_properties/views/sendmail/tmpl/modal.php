...
<form action="index.php?option=com_properties&amp;view=products&amp;layout=modal&amp;tmpl=component&amp;object=<?php echo JRequest::getVar('object');?>" method="post" name="adminForm">
<table width="100%">
	<tr>
...
<a style="cursor: pointer;" onclick="window.parent.jSelectProperty('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$row->name); ?>', '<?php echo JRequest::getVar('object'); ?>');">
