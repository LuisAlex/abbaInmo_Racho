...
function _buildQuery()
	{		
		switch($this->filter_order)
			...
			break;
			case 'published' :
			$this->filter_order='l.published';
			break;
			default:
			$this->filter_order='l.ordering';
			break;
			}
		...
		if ( $this->filter_multisid )
		{			
				$where[] = 'l.parent IN ('.implode(',',$this->filter_multisid).')';					
		}elseif ( $this->filter_sid )
		{			
...
function __construct()
  {
	...
	global $mainframe, $option;
		...
		$this->filter_multisid		= $mainframe->getUserStateFromRequest( "$option.filter_multisid",		'filter_multisid',		'',		'array' );
