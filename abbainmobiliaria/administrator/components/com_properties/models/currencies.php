...
class PropertiesModelCurrencies extends JModel
{
	var $_data;
	var $TableName = null;	
...
function _buildQuery()
	...
	switch($this->filter_order)
		...
		if ($this->search)
		{
			$where[] = 'LOWER(currency) LIKE \''. $this->search. '\'';
		}
...
function getPagination()
 ...
 function &getCurrencies()
	{					
		$query = ' SELECT * FROM #__properties_currencies '.
					'  WHERE id = '.$this->_id;
