...
if ($showSelectBedrooms) {
$or_more=$exactBedrooms ? '' : ' '.JText::_('o mas');
$Md[0]->id_dormitorios='';
...
$Md[5]->dormitorios='5 '.JText::_('Bedrooms');
...
if ($showSelectBathrooms) {
$or_more=$exactBathrooms ? '' : ' '.JText::_('o mas');
$Mb[0]->id_bathrooms='';
$Mb[0]->bathrooms=JText::_('Bathrooms');
$Mb[1]->id_bathrooms=1;
$Mb[1]->bathrooms='1 '.JText::_('Bathroom');
$Mb[2]->id_bathrooms=2;
$Mb[2]->bathrooms='2 '.JText::_('Bathrooms');
$Mb[3]->id_bathrooms=3;
$Mb[3]->bathrooms='3 '.JText::_('Bathrooms');
$Mb[4]->id_bathrooms=4;
$Mb[4]->bathrooms='4 '.JText::_('Bathrooms');
$Mb[5]->id_bathrooms=5;
$Mb[5]->bathrooms='5 '.JText::_('Bathrooms');
...
<?php
	...
	$buttonText = JText::_('Results not founddddd');
	}
?>
