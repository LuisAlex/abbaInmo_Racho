...
$xmlURL = JURI::root()."index.php?option=com_globalflashgalleries%26view=xml%26format=raw%26id={$this->gallery->id}";
...
<script type="text/javascript">//<![CDATA[
	jQuery('#<?php echo $uniqueFlashID; ?> .globalflash-altcontent').altgallery({
		width: '<?php echo $width; ?>',
		height: '<?php echo $height; ?>',
		images: { folder:'<?php echo globalflash_frontendURL.'/images' ?>' },
		config: '<?php echo JURI::root()."index.php?option=com_globalflashgalleries&view=xml&format=raw&id={$this->gallery->id}"; ?>',
		configType: 'xml'
	});
//]]></script>
