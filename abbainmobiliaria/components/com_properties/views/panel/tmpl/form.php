...
?>
         ...
         <select name="available" style="width:150px;"> 
			<option <?php echo $select0;?> value="0"><?php echo JText::_( 'DETAILS_MARKET000' ); ?></option>
...
<tr>
					...
					<td>
                    <input class="text_area" type="text" name="video" id="video" size="60" maxlength="255" value="<?php echo $this->datos->video; ?>" />						
					</td>
				</tr>
...
<div class="noshow">
<fieldset class="adminform"> <table class="admintable" width="100%">
<legend><?php echo JText::_( 'Datos de propietario' ); ?></legend>
...
<?php 
if(!$this->datos->id){ 
echo 'save property to add images';
}
if($this->datos->id){ 
...
<table class="admintable">
                ...
                <tr>
					...
					<td >
                   <strong>                   
                   <a class="modal" title="<?php echo JText::_( 'GET COORD' ); ?>" href="<?php //echo JURI::root();?>index.php?option=com_properties&view=panel&layout=mapgetcoord&id=<?php echo $this->datos->id;?>" rel="{handler: 'iframe', size: {x: 750, y: 475}}"><?php echo JText::_( 'GET COORD' ); ?></a>                   
