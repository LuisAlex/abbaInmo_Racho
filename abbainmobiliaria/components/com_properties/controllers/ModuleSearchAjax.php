...
$or_more=$exactBedrooms ? '' : 'or more ';
$Md[0]->id_dormitorios='';
$Md[0]->dormitorios=JText::_('Bedrooms');
$Md[1]->id_dormitorios=1;
$Md[1]->dormitorios='1 '.JText::_($or_more.'Bedroom');
$Md[2]->id_dormitorios=2;
$Md[2]->dormitorios='2 '.JText::_($or_more.'Bedrooms');
$Md[3]->id_dormitorios=3;
$Md[3]->dormitorios='3 '.JText::_($or_more.'Bedrooms');
$Md[4]->id_dormitorios=4;
$Md[4]->dormitorios='4 '.JText::_($or_more.'Bedrooms');
$Md[5]->id_dormitorios=5;
$Md[5]->dormitorios='5 '.JText::_('or more Bedrooms');
...
$Mb[1]->id_bathrooms=1;
$Mb[1]->bathrooms='1 '.JText::_($or_more.'Bathroom');
$Mb[2]->id_bathrooms=2;
$Mb[2]->bathrooms='2 '.JText::_($or_more.'Bathrooms');
$Mb[3]->id_bathrooms=3;
$Mb[3]->bathrooms='3 '.JText::_($or_more.'Bathrooms');
$Mb[4]->id_bathrooms=4;
$Mb[4]->bathrooms='4 '.JText::_($or_more.'Bathrooms');
$Mb[5]->id_bathrooms=5;
$Mb[5]->bathrooms='5 '.JText::_('or more Bathrooms');
...
if($ms_area==1)
	...
	echo '<div class="area_title">'.JText::_('Default Area').'</div>';
	...
	echo '<div class="area_title">'.JText::_('Covered Area').'</div>';
